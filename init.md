...
станет дооступна в пк браузере по адресу: localhost:8000<br><br>

Чтобы увидеть страницу на телефоне, то в его бразуер нужно вбить<br>
ip адрес компьютера, с которого был запущен сервер.<br>
Мне пришлось вбивать 192.168.0.10:8000<br>
\* порт обязателен<br>
