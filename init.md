...
## \[ cmd.exe \] - быстро
Для вызова терминала<span hidden>командной строки\\консоли<span> по текущей директории в Windows,<br>достаточно вбить `cmd` в путь проводника...<span hidden>в адресную строку\\<span><br>_\* easy-peasy_
