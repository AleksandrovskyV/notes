...
## \[ cmd.exe \] - быстро
Для вызова терминала<!-- командной строки\\консоли--> по текущей директории в Windows,<br>достаточно вбить `cmd` в путь <!-- в адресную строку-->проводника...<br>_\* easy-peasy_
...
> \* *естественно, с установленным <strong style="color: black; text-decoration: underline;">[https://www.python.org/]()</strong>* 
