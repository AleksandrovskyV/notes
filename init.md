...
## \[ naming drives \]
На Windows я даю имена жёстким дискам с префиксом<br> 
буквы `letter` на которую тот ссылается. Вместо `MySummer2222`<br> 
который ссылается на букву `(E:)`, называю типа `DiskE`<br> 
При переподключении ясно знаешь, кем он был...<br> 
