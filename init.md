...
## \[ cmd.exe \] - быстро
Вызвать терминал<!-- командной строки\\консоли--> по текущей директории в Windows,<br>можно просто вбив `cmd` в путь <!-- в адресную строку-->проводника...<br>_\* easy-peasy_
