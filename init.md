...
## \[ naming drives \]
В Windows предпочитаю даавать имена жёстким дискам<br>
вклачая в них букву "letter", на которую он ссылается. Пример:<br>
Вместо `MySummer31 (E:)`<br> 
именую типа `DiskE (E:)`<br><br>

И переподключая ясно знаешь, кем он был...<br>
