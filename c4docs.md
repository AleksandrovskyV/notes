...
_\*Типа, чтобы кнопочка растягивались по панельке/группе, нужно в аргумент закинуть корректную константу и как пример:&nbsp;
self.AddStaticText(666, c4d.BFH_SCALEFIT, name="кнопка")_
