...
В начале следуют импорты стандартных библиотек python,<br>

<details markdown="1"><summary>в них...</summary>
...
Естественно, помимо стандартных никто не мешает скачать любые сторонние, но стоит помнить: что, где и как вы качали\*
</summary>
...
..нуу, из нас двоих ты пихал в GetDataAddressW искажённые данные, делая проекты битыми)
