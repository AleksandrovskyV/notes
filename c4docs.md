...
И под конец вызова там идёт именной/необязательный аргумент: <strong>name="кнопка"</strong>,<br>который отличается от первых двух наличием "=", говоря о его происхождении.<br>Может там быть, а может и не быть, такая у него неопределённость ~
