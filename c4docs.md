...
\- Отвечу честно, что не знаю о них ничего, кроме факта:<br>без них метод на выполнится, так как писатель посчитал вынести их обязательными<br>при вызове, и что идут они в строгом порядке друг за другом... <br>

name="кнопка" - это именной аргумент, который может быть, а может<br>и не быть. Такая вот неопределённость ~
