...
И в конце примера идёт именной/необязательный аргумент: <strong>name="кнопка"</strong>,<br>который отличается от первых двух наличием <strong>"="</strong>, говорящим о своём происхождении.<br>Именные кстати могут стоят в разном, отсительно друга друга, порядке и попросту отсутствовать на вызове. <br>Такие вот неопределённые типы...<br><br>"Типы..." - взят небезопасный термин к такому типу абзаца... 
<br><br><br><br>