...
И под конец вызова там идёт именной/необязательный аргумент<strong>name="кнопка"</strong>,<br>который отличается наличием "=", говоря о его происхождении.<br>Он там может быть, а может и не быть...<br>Такая вот у него неопределённость ~
