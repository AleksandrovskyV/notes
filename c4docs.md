...
Ты спросишь у меня:  <strong>&£%!</strong>, позиционный аргумент? А я отвечу честно, что не знаю о них ничего, кроме факта:<br>без них метод на выполнится, так как писатель посчитал вынести их обязательными при вызове, и что идут они в строгом порядке друг за другом... <br>
