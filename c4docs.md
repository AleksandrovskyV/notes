...
Честно отвечу, что не знаю о них ничего, кроме факта: без них вызов метода на выполнится,<br>так как писатель посчитал вынести их обязательными на вызове, добавив в сигнатуру (шапку) функции.<br>А также что, идут они в строгом порядке, друг за другом<br>

И в конце примера идёт именной/необязательный аргумент: <strong>name="кнопка"</strong>,<br>который отличается от первых двух наличием <strong>"="</strong>, что говорит о его происхождении.<br>Кстати именные могут стоять в разном, относительно друга друга, порядке и попросту отсутствовать. <br>Такие вот они неопределённые типы...<br><br><strong>AI:</strong> И термин "тип" был взят тобой опромечтиво к такому типу абзаца... <br>
