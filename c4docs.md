...
Ты спросишь у меня:  <strong>&£%!</strong>, позиционный аргумент? А я отвечу честно, что не знаю о них ничего, кроме факта:<br>без них метод на выполнится, так как писатель посчитал вынести их обязательными<br>при вызове, и что идут они в строгом порядке друг за другом... <br>

name="кнопка" - именной аргумент который может быть, а<br>может и не быть. Такая у него неопределённость ~
