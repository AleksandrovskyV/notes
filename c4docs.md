...
Ты спросишь у меня:  <strong>&£%!</strong>, позиционный аргумент?
Честно отвечу, что не знаю о них ничего, кроме факта: без них метод на выполнится,<br>так как писатель посчитал вынести их обязательными на вызове. А также, что идут они в строгом порядке друг за другом... <br>

name="кнопка" - именной аргумент который может быть, а может и не быть.<br>Такая вот у него неопределённость ~
