...
вспомогательный [класс](https://developers.maxon.net/docs/py/2026_3_0/modules/c4d.gui/GeDialog/index.html?highlight=gedialog#c4d.gui.GeDialog) лежащим в модуле c4d ( <strong>import</strong> c4d  # ага) для создания интерфейса <br>в окне\панели программы
...
В конце примера красуется именной и необязательный аргумент вида: <strong>name="кнопка"</strong>,<br>что отличается от первых двух наличием <strong>"="</strong>. Внезапно, именные могут стоять <br>в разном `друг от друга` порядке и просто отсутствовать.<br>Такие вот неопределённые они, типы<br><br>
