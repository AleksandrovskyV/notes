...
А в конце примера стоит именной и необязательный аргумент вида: <strong>name="кнопка"</strong>, что отличается от первых двух наличием <strong>"="</strong>, говорящим о его происхождении.<br>Внезапно, именные могут стоять в разном относительно `друг от друга` порядке и попросту отсутствовать. <br>Такие вот они, неопределённые типы...<br><br><br><strong>AI:</strong> Термин "тип" был взят тобой опрометчиво к такому типу абзаца... <br>
